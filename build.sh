...
cd DRG_sprout
zip -r Black_caps-10.0-GCC-FIH-SDM660-2018-$(date +"%Y%m%d").zip META-INF patch tools Image.gz-dtb anykernel.sh
cp -r Black_caps-10.0-GCC-FIH-SDM660-2018-$(date +"%Y%m%d").zip $path/black_caps
cd
cd $path
cd black_caps
